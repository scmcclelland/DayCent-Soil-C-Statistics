...
#                 1. Using multi-scenario data tables to create annotated CDF plots
#                 2. Reading-in or creating these multi-scenario tables by loading multiple daycent scenarios for a given region, cleaning and filtering before re-exporting these tables for later use.
#-------------------------------------------------------------------------------
# libraries 
#-------------------------------------------------------------------------------
